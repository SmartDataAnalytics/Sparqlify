...
typeCtorExpression
    : BNODE '(' expression (',' expression)* ')' -> ^(BNODE ^(EXPRESSION_LIST expression*))

    | URI '(' expression (',' expression)* ')' -> ^(URI ^(EXPRESSION_LIST expression*))
    ...
    | IRI '(' expression (',' expression)* ')' -> ^(IRI ^(EXPRESSION_LIST expression*))
