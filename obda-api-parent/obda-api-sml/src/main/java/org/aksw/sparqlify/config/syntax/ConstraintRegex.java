...
{	
	...
	public ConstraintRegex(Var var, String attribute, PatternPro pattern) {
		super();
		this.var = var;
		this.attribute = attribute;
	...
	public ConstraintRegex copySubstitute(Map<? extends Node, Node> map) {
		Var value = (Var)map.get(var);
		if(value == null || var.equals(value)) {
			return this;
		}

		return new ConstraintRegex(value, attribute, pattern);
	}
