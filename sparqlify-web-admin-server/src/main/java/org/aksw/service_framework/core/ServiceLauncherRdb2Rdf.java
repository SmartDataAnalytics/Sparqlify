...
//		em.merge(serviceConfig);
        ...
        try {
            ...
            QueryExecutionFactory qef = SparqlifyUtils.createDefaultSparqlifyEngine(dataSource, smlConfig, sqlEscaper, maxResultSetRows.longValue(), maxExecutionTimeInSeconds);
