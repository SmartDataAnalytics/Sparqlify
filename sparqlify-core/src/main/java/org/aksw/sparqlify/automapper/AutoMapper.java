    ...
    public static void main(String[] args) throws SQLException {
        ...
        */
        ...
        for(Relation relation : relations.values()) {
            ...
            Node classUri = NodeFactory.createURI(prefix + StringUtils.toUpperCamelCase(relation.getName()));
            ...
            for(ForeignKey fk : fks) {
                ...
                */
                ...
                Node property = NodeFactory.createURI(prefix + StringUtils.toLowerCamelCase(fk.getTarget().getTableName()));
            ...
            for(Column column : nonKeyColumns) {
                ...
                Node datatype = NodeFactory.createURI("http://aksw.org/sparqlify/unknown-datatype");
                if(dt != null) {
                    Node xsd = dt.getXsd();
                    if(xsd != null) {
                        datatype = xsd;
