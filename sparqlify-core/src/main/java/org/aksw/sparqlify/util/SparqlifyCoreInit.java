...
import org.aksw.sparqlify.core.cast.SqlLiteralMapperOracle;
...
public class SparqlifyCoreInit {
    public static SqlExprSerializerSystem createSerializerSystem(TypeSystem typeSystem) {
        ...
        //TypeSerializer typeSerializer = new TypeSerializerPostgres();
        TypeSerializer typeSerializer = new TypeSerializerOracle();

        SqlLiteralMapper sqlLiteralMapper = new SqlLiteralMapperOracle(
                typeSerializer);
