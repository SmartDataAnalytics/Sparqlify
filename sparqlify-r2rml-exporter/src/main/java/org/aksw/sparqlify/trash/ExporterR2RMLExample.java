...
import org.aksw.r2rml.jena.plugin.R2rmlModuleRegistry;
...
public class ExporterR2RMLExample {
		...
		throws Exception
	{
		...
		*/
		...
		Collection<org.aksw.sparqlify.config.syntax.ViewDefinition> vds = new R2rmlImporter().read(model);
		
		
		for(org.aksw.sparqlify.config.syntax.ViewDefinition vd : vds) {
